        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col">
            ...
            <div className="shorts-list-container relative -mx-4 px-4 sm:mx-0 sm:px-0 overflow-x-auto no-scrollbar scroll-smooth">
              <div className="flex items-stretch gap-2.5 sm:gap-3.5 min-w-[700px] sm:min-w-0">
                {shorts.slice(0, 5).map((short, idx) => (
                  <article
                    key={short.id || idx}
                    id={`s04-short-card-${idx + 1}`}
                    className="short-card flex-1 relative aspect-[9/15] rounded-md overflow-hidden group shadow-sm bg-slate-900 select-none flex flex-col justify-end"
                  >
                    <a
                      href={short.href}
                    ...
                    >
                      ...
                      <div className="absolute top-2.5 left-0 right-0 flex justify-center z-10 pointer-events-none opacity-85">
                      ...
                      <div className="relative z-10 mt-auto">
                        <h3 className="text-xs sm:text-[13px] font-bold text-white leading-snug line-clamp-3 group-hover:text-red-100 transition-colors drop-shadow-sm font-sans">
                          {short.title}
                        </h3>
                      </div>
                    </a>
          ...
          <aside
            ...
            className="lg:col-span-4 bg-white rounded-xl border border-slate-200/80 p-4 sm:p-5 shadow-xs"
          >
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-shrink-0 mt-0.5">
                      <span className="w-8 h-8 rounded-full bg-[#c8102e] text-white font-extrabold text-sm flex items-center justify-center shadow-xs group-hover:scale-105 transition-transform">
                        {item.rank}
                      </span>
                    </div>
