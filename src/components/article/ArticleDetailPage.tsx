...
export const BacaJugaBlock: React.FC<{
  ...
  return (
    <aside
      ...
      className="baca-juga-inline not-prose my-6 sm:my-7 p-3.5 sm:p-4 bg-[#f8f9fa] border border-slate-200/70 rounded-lg shadow-2xs group transition-colors hover:bg-slate-100/70 hover:border-slate-300"
    >
      <a
        href={item.href}
        onClick={(e) => {
...
export const ArticleDetailPage: React.FC<ArticleDetailPageProps> = ({
  ...
  const handleCopyLink = () => {
    if (typeof window !== 'undefined') {
      const url = `${window.location.origin}/berita/${currentData.slug}`;
  ...
  const handleShareWindow = (platform: string) => {
    if (typeof window === 'undefined') return;
    const url = encodeURIComponent(`${window.location.origin}/berita/${currentData.slug}`);
    const text = encodeURIComponent(currentData.title);
    let shareUrl = '';
    ...
    <main id="article-detail-main" className="flex-1 w-full bg-[#f8f9fa] py-3 sm:py-4 lg:py-5">
      ...
      <div className="max-w-[980px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="article-layout grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start">
          ...
          {/* ========================================================================= */}
          <article className="article-page lg:col-span-8 w-full bg-white rounded-xl border border-slate-200/80 shadow-xs p-4 sm:p-5 md:p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 mb-6 border-b border-slate-100">
              ...
              {/* Right: Compact Circular Share Icons */}
              <div className="flex items-center gap-2 self-start sm:self-center">
                {/* Facebook */}
                <button
                  type="button"
                  onClick={() => handleShareWindow('facebook')}
                  className="w-8 h-8 rounded-full bg-[#1877f2] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs"
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-full bg-[#25d366] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs"
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs"
                ...
                <button
                  type="button"
                  onClick={() => handleShareWindow('telegram')}
                  className="w-8 h-8 rounded-full bg-[#0088cc] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs"
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded-full flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs ${
                    copiedToast
                      ? 'bg-emerald-600 text-white'
                      : 'bg-slate-600 text-white'
                  }`}
                  aria-label="Salin Tautan"
                  title={copiedToast ? 'Tautan Tersalin!' : 'Salin Tautan'}
                >
                  {copiedToast ? (
            ...
            <div className="mt-8 p-4 sm:p-5 bg-[#f8f9fa] rounded-lg border border-slate-200/80">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-2.5">
                {currentData.tags.map((tag) => (
                  <a
                    ...
                    className="inline-flex items-center px-3.5 py-1.5 rounded-md bg-gradient-to-r from-[#d91424] via-[#9e165b] to-[#431474] text-white font-medium text-xs sm:text-[13px] hover:opacity-90 active:scale-95 transition-all shadow-2xs"
                  >
                    # {tag.name}
                  </a>
                ))}
            ...
            <div className="mt-3.5 p-3.5 sm:p-4 bg-[#f8f9fa] rounded-lg border border-slate-200/80 flex items-center justify-between gap-3 sm:gap-4 flex-wrap sm:flex-nowrap">
              ...
              <div className="flex items-center gap-2 sm:gap-2.5 ml-auto sm:ml-0">
                ...
                <button
                  type="button"
                  onClick={() => handleShareWindow('facebook')}
                  className="w-8 h-8 rounded-full bg-[#1877f2] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs cursor-pointer"
                  aria-label="Bagikan ke Facebook"
                  title="Bagikan ke Facebook"
                >
                  <Facebook className="w-4 h-4 fill-current" />
                ...
                <button
                  type="button"
                  onClick={() => handleShareWindow('whatsapp')}
                  className="w-8 h-8 rounded-full bg-[#25d366] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs cursor-pointer"
                  aria-label="Bagikan ke WhatsApp"
                  title="Bagikan ke WhatsApp"
                >
                  <MessageCircle className="w-4 h-4 fill-current" />
                ...
                <button
                  type="button"
                  onClick={() => handleShareWindow('twitter')}
                  className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs cursor-pointer"
                  aria-label="Bagikan ke X"
                  title="Bagikan ke X"
                >
                  <span className="font-bold text-xs">𝕏</span>
                ...
                <button
                  type="button"
                  onClick={() => handleShareWindow('telegram')}
                  className="w-8 h-8 rounded-full bg-[#0088cc] text-white flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs cursor-pointer"
                  aria-label="Bagikan ke Telegram"
                  title="Bagikan ke Telegram"
                >
                  <Send className="w-3.5 h-3.5" />
                ...
                <button
                  type="button"
                  onClick={handleCopyLink}
                  className={`w-8 h-8 rounded-full flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-2xs cursor-pointer ${
                    copiedToast
                      ? 'bg-emerald-600 text-white'
                      : 'bg-slate-600 text-white'
                  }`}
                  ...
                  title={copiedToast ? 'Tautan Tersalin!' : 'Salin Tautan'}
                >
                  {copiedToast ? <Check className="w-4 h-4" /> : <Link2 className="w-4 h-4" />}
                </button>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {relatedArticlesList.map((item) => (
                  <a
                    ...
                    className="group p-3 rounded-lg border border-slate-200/80 hover:border-red-300 hover:shadow-xs transition bg-white flex gap-3 items-start"
                  >
                    <img
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {interestingStoriesList.map((story) => (
                  <a
                    ...
                    className="group flex flex-col bg-slate-50 hover:bg-white rounded-lg border border-slate-200 overflow-hidden shadow-2xs hover:shadow-sm transition"
                  >
            ...
            <section className="mt-10 pt-6 border-t border-slate-200">
              ...
              {/* Write Comment Form */}
              <form onSubmit={handleAddComment} className="mb-6 bg-white p-4 rounded-xl border border-slate-200 shadow-2xs">
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs sm:text-sm border border-slate-200 rounded-lg focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600"
                  />
                </div>
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    className="w-full p-3 text-xs sm:text-sm border border-slate-200 rounded-lg focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-600 resize-none"
                    required
                  />
                </div>
                <div className="flex items-center justify-between flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white font-bold text-xs rounded-lg transition shadow-2xs flex items-center gap-1.5 cursor-pointer"
                  >
              ...
              <div className="space-y-3">
                {commentsList.map((comm) => (
                  <div key={comm.id} className="p-3.5 rounded-lg bg-slate-50 border border-slate-200/80">
