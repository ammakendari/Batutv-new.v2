                ...
                <div className="flex items-stretch gap-2.5 sm:gap-3.5 min-w-[700px] sm:min-w-0">
                  {displayShorts.map((short, idx) => (
                    <article
                      ...
                      className="short-card flex-1 relative aspect-[9/15] rounded-md overflow-hidden group shadow-2xs bg-slate-900 select-none flex flex-col justify-end"
                    >
                      <a
                        href={short.href}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                {displayVideos.map((video, idx) => (
                  <article
                    ...
                    className="video-card bg-white rounded-xl border border-slate-200/80 overflow-hidden shadow-2xs hover:shadow-md transition-shadow duration-300 flex flex-col group"
                  >
                    <a
                      href={video.href}
