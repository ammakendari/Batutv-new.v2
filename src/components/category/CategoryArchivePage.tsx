    ...
    <div className="min-h-screen bg-[#f8f9fa] text-slate-900 font-sans pb-16">
      ...
      <div className="max-w-[980px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-5 lg:pt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start">
          ...
          {/* ========================================================================= */}
          {/* KOLOM KANAN (Desktop: 4 COLS): BANNER SPONSOR AD + DISKUSI TERPANAS       */}
          {/* ========================================================================= */}
          <aside className="lg:col-span-4 space-y-5 w-full lg:sticky lg:top-[68px] self-start">
            {/* 1. SPONSOR AD (Persis seperti Homepage S03 Right Ad Banner) */}
            <div
              id="category-sponsor-ad"
            ...
            >
              ...
              {/* Ad Card Content */}
              <div className="p-4 sm:p-5 flex flex-col text-center items-center justify-between min-h-[380px] bg-gradient-to-b from-white via-slate-50/50 to-red-50/20">
                {/* Brand & Slogan */}
                ...
                <div className="my-2.5 space-y-1">
                  <h3 className="text-base font-black text-blue-900 uppercase tracking-tight leading-tight">
                    MERDEKA MENCETAK ONLINE ROADSHOW
                  </h3>
                  <p className="text-[11px] font-bold text-sky-600">
                    Periode promo : 01-31 Agustus 2026
                  </p>
                </div>

                {/* Graphic Banner Area */}
                <div className="my-2 w-full relative py-1 flex flex-col items-center">
                  <div className="inline-block bg-gradient-to-r from-red-600 via-red-700 to-red-600 text-white text-xs font-black px-3.5 py-1 rounded-md shadow-md border-2 border-white transform -rotate-1 mb-2">
                    MERDEKA MENCETAK
                  </div>

                  <div className="flex items-center justify-center gap-2 my-1.5 w-full">
                    <div className="w-22 h-14 bg-slate-900 rounded-lg shadow-sm flex flex-col items-center justify-center text-[9px] text-white font-mono p-1 border border-slate-700">
                      <div className="w-14 h-1.5 bg-slate-700 rounded-xs mb-1" />
                      <span className="text-red-400 font-bold">L121</span>
                      <span className="text-[8px] text-slate-400">EcoTank</span>
                    </div>
                    <div className="w-26 h-18 bg-slate-900 rounded-lg shadow-md flex flex-col items-center justify-center text-[10px] text-white font-mono p-1.5 border border-slate-700">
                      <div className="w-18 h-2 bg-slate-700 rounded-xs mb-1" />
                ...
                <div className="w-full mt-2.5 p-2 bg-gradient-to-r from-blue-900 to-sky-800 text-white rounded-xl shadow-sm text-center">
                  <p className="text-[11px] font-black text-amber-300 uppercase tracking-wide">
                    DAPATKAN SHOPPING VOUCHER (IDR 150.000)
                  </p>
                  <p className="text-[9.5px] text-slate-200 font-medium mt-0.5">
                    Setiap pembelian Produk L121, L3211, L3251
                  </p>
                </div>
              </div>
            </div>
