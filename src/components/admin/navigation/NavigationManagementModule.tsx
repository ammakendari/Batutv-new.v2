          ...
          <div className="flex items-start sm:items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Kelola menu utama, submenu dropdown, dan tautan internal CMS (Maksimal 2 level) yang langsung terhubung ke SO2 Homepage.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center flex-wrap gap-2.5">
            {onNavigateToPublic && (
              <button
                ...
                className="px-3.5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-xl transition flex items-center gap-1.5 border border-slate-200"
              >
                <Globe className="w-4 h-4 text-slate-500" />
                <span>Lihat Homepage SO2</span>
              </button>
            )}
            ...
            <button
              ...
              className="px-4 py-2.5 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-xl transition flex items-center gap-2 shadow-sm shadow-red-600/30"
            >
